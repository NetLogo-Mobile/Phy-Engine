...
inline constexpr ::phy_engine::model::model_base *get_model(netlist &nl, model_pos pos) noexcept {
	return get_model(nl, pos.vec_pos, pos.chunk_pos);
}
...
inline constexpr bool delete_wire(netlist &nl, model_pos mp1, ::std::size_t n1, model_pos mp2, ::std::size_t n2) noexcept {
	return {};
}
