...
namespace phy_engine::model
{
    struct sawtooth_gen
    {
        inline static constexpr ::fast_io::u8string_view model_name{u8"Sawtooth Wave Generator"};

        inline static constexpr ::phy_engine::model::model_device_type device_type{::phy_engine::model::model_device_type::linear};
        inline static constexpr ::fast_io::u8string_view identification_name{u8"SAW"};
    ...
    static_assert(::phy_engine::model::model<sawtooth_gen>);

    inline constexpr bool set_attribute_define(::phy_engine::model::model_reserve_type_t<sawtooth_gen>, sawtooth_gen& g, ::std::size_t idx, ::phy_engine::model::variant vi) noexcept
    {
        switch(idx)
        {
    ...
    static_assert(::phy_engine::model::defines::has_set_attribute<sawtooth_gen>);

    inline constexpr ::phy_engine::model::variant get_attribute_define(::phy_engine::model::model_reserve_type_t<sawtooth_gen>, sawtooth_gen const& g, ::std::size_t idx) noexcept
    {
        switch(idx)
        {
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute<sawtooth_gen>);

    inline constexpr ::fast_io::u8string_view get_attribute_name_define(::phy_engine::model::model_reserve_type_t<sawtooth_gen>, ::std::size_t idx) noexcept
    {
        switch(idx)
        {
            case 0: return u8"Vh";
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute_name<sawtooth_gen>);

    inline constexpr bool iterate_tr_define(::phy_engine::model::model_reserve_type_t<sawtooth_gen>, sawtooth_gen const& g, ::phy_engine::MNA::MNA& mna, double tTime) noexcept
    {
        ...
        if(node_P && node_M) [[likely]]
        {
            ...
            double const slope{(g.Vh - g.Vl) / T};
            double const val{g.Vl + slope * t};
    ...
    static_assert(::phy_engine::model::defines::can_generate_pin_view<sawtooth_gen>);

    inline constexpr ::phy_engine::model::branch_view generate_branch_view_define(::phy_engine::model::model_reserve_type_t<sawtooth_gen>, sawtooth_gen& g) noexcept
    {
        return {__builtin_addressof(g.branches), 1};
    }

    static_assert(::phy_engine::model::defines::can_generate_branch_view<sawtooth_gen>);
}
