...
namespace phy_engine::model
{
    struct NOR
    {
        inline static constexpr ::fast_io::u8string_view model_name{u8"NOR"};
        ...
        inline static constexpr ::fast_io::u8string_view identification_name{u8"NOR"};
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute<NOR>);

    inline constexpr ::fast_io::u8string_view get_attribute_name_define(::phy_engine::model::model_reserve_type_t<NOR>, ::std::size_t n) noexcept
    {
        switch(n)
        {
            case 0: return {u8"Ll"};
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute_name<NOR>);

    inline bool prepare_tr_define(::phy_engine::model::model_reserve_type_t<NOR>, NOR& clip) noexcept
    {
        clip.duration_A = 0.0;
    ...
    static_assert(::phy_engine::model::defines::can_prepare_tr<NOR>);

    inline constexpr ::phy_engine::digital::need_operate_analog_node_t update_digital_clk_define(::phy_engine::model::model_reserve_type_t<NOR>,
                                                                                                 NOR& clip,
                                                                                                 ...
                                                                                                 ::phy_engine::model::digital_update_method_t method) noexcept
    {
        ...
        if(node_ia && node_ib && node_o) [[likely]]
        {
            ...
            auto const res_or{clip.inputA | clip.inputB};
            auto const output_res{inv(res_or)};
            bool output_change{};
    ...
    static_assert(::phy_engine::model::defines::can_update_digital_clk<NOR>);

    inline constexpr ::phy_engine::model::pin_view generate_pin_view_define(::phy_engine::model::model_reserve_type_t<NOR>, NOR& clip) noexcept
    {
        return {clip.pins, 3};
    }
