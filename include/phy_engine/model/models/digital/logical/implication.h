...
namespace phy_engine::model
{
    struct IMP
    {
        inline static constexpr ::fast_io::u8string_view model_name{u8"IMP"};
        ...
        inline static constexpr ::fast_io::u8string_view identification_name{u8"IMP"};
    ...
    static_assert(::phy_engine::model::model<IMP>);

    inline constexpr bool set_attribute_define(::phy_engine::model::model_reserve_type_t<IMP>, IMP& clip, ::std::size_t n, ::phy_engine::model::variant vi) noexcept
    {
        switch(n)
        {
    ...
    static_assert(::phy_engine::model::defines::has_set_attribute<IMP>);

    inline constexpr ::phy_engine::model::variant get_attribute_define(::phy_engine::model::model_reserve_type_t<IMP>, IMP const& clip, ::std::size_t n) noexcept
    {
        switch(n)
        {
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute<IMP>);

    inline constexpr ::fast_io::u8string_view get_attribute_name_define(::phy_engine::model::model_reserve_type_t<IMP>, ::std::size_t n) noexcept
    {
        switch(n)
        {
            case 0: return {u8"Ll"};
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute_name<IMP>);

    inline bool prepare_tr_define(::phy_engine::model::model_reserve_type_t<IMP>, IMP& clip) noexcept
    {
    ...
    static_assert(::phy_engine::model::defines::can_prepare_tr<IMP>);

    inline constexpr ::phy_engine::digital::need_operate_analog_node_t update_digital_clk_define(::phy_engine::model::model_reserve_type_t<IMP>,
                                                                                                 IMP& clip,
                                                                                                 ...
                                                                                                 ::phy_engine::model::digital_update_method_t method) noexcept
    {
        ...
        if(node_ia && node_ib && node_o) [[likely]]
        {
            ...
            auto const output_res{inv(clip.inputA) | clip.inputB};
            bool output_change{};
    ...
    static_assert(::phy_engine::model::defines::can_update_digital_clk<IMP>);

    inline constexpr ::phy_engine::model::pin_view generate_pin_view_define(::phy_engine::model::model_reserve_type_t<IMP>, IMP& clip) noexcept
    {
        return {clip.pins, 3};
    }

    static_assert(::phy_engine::model::defines::can_generate_pin_view<IMP>);
}  // namespace phy_engine::model
