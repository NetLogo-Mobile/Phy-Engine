...
namespace phy_engine::model
{
    ...
    inline constexpr bool
        set_attribute_define(::phy_engine::model::model_reserve_type_t<IMP>, IMP& clip, ::std::size_t n, ::phy_engine::model::variant vi) noexcept
    {
        switch(n)
        {
            case 0:
    ...
    inline constexpr ::phy_engine::model::variant
        get_attribute_define(::phy_engine::model::model_reserve_type_t<IMP>, IMP const& clip, ::std::size_t n) noexcept
    {
        switch(n)
        {
