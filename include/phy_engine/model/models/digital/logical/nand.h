...
namespace phy_engine::model
{
    struct NAND
    {
        inline static constexpr ::fast_io::u8string_view model_name{u8"NAND"};
        ...
        inline static constexpr ::fast_io::u8string_view identification_name{u8"NAND"};
    ...
    static_assert(::phy_engine::model::model<NAND>);

    inline constexpr bool
        set_attribute_define(::phy_engine::model::model_reserve_type_t<NAND>, NAND& clip, ::std::size_t n, ::phy_engine::model::variant vi) noexcept
    {
        switch(n)
        {
            case 0:
    ...
    static_assert(::phy_engine::model::defines::has_set_attribute<NAND>);

    inline constexpr ::phy_engine::model::variant
        get_attribute_define(::phy_engine::model::model_reserve_type_t<NAND>, NAND const& clip, ::std::size_t n) noexcept
    {
        switch(n)
        {
            case 0:
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute<NAND>);

    inline constexpr ::fast_io::u8string_view get_attribute_name_define(::phy_engine::model::model_reserve_type_t<NAND>, ::std::size_t n) noexcept
    {
        switch(n)
        {
            case 0:
    ...
    static_assert(::phy_engine::model::defines::has_get_attribute_name<NAND>);

    inline bool prepare_tr_define(::phy_engine::model::model_reserve_type_t<NAND>, NAND& clip) noexcept
    {
        clip.duration_A = 0.0;
    ...
    static_assert(::phy_engine::model::defines::can_prepare_tr<NAND>);

    inline constexpr ::phy_engine::digital::need_operate_analog_node_t update_digital_clk_define(::phy_engine::model::model_reserve_type_t<NAND>,
                                                                                                 NAND& clip,
                                                                                                 ...
                                                                                                 ::phy_engine::model::digital_update_method_t method) noexcept
    {
        ...
        if(node_ia && node_ib && node_o) [[likely]]
        {
            ...
            auto const res_and{clip.inputA & clip.inputB};
            auto const output_res{inv(res_and)};
            bool output_change{};
    ...
    static_assert(::phy_engine::model::defines::can_update_digital_clk<NAND>);

    inline constexpr ::phy_engine::model::pin_view generate_pin_view_define(::phy_engine::model::model_reserve_type_t<NAND>, NAND& clip) noexcept
    {
        return {clip.pins, 3};
    }

    static_assert(::phy_engine::model::defines::can_generate_pin_view<NAND>);
}  // namespace phy_engine::model
