...
namespace phy_engine::model
{
    ...
    inline constexpr ::phy_engine::digital::need_operate_analog_node_t update_digital_clk_define(::phy_engine::model::model_reserve_type_t<HALF_SUB>,
                                                                                                 HALF_SUB& clip,
                                                                                                 ...
                                                                                                 ::phy_engine::model::digital_update_method_t /*method*/) noexcept
    {
        ...
        if(node_a && node_b && node_d && node_br) [[likely]]
        {
            ...
            {
                if(clip.last_b != BR) { clip.last_b = BR; node_br->node_information.dn.state = BR; table.tables.insert(node_br); }
            }
